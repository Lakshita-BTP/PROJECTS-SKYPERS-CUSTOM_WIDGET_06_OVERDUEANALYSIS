(function () {
  class OverdueAnalysis extends HTMLElement {
    ...
    async serializeCustomWidgetToImage() {
      ...
      ctx.fillText(this._title, 15, 32);
      ...
      data.forEach((item, index) => {
        ...
        ctx.textAlign = "right";
        ctx.fillText(this.formatValue(item.value), width - 15, y);
        ctx.textAlign = "left";
        y += 10;
        ctx.fillStyle = "#E5E7EB";

        ctx.beginPath();
        ctx.roundRect(15, y, width - 30, 18, 9);
        ...
        ctx.beginPath();
        ctx.roundRect(15, y, ((width - 30) * percent) / 100, 18, 9);
