(function () {
  class OverdueAnalysis extends HTMLElement {
    ...
    async serializeCustomWidgetToImage() {
      ...
      console.log("DATA", this._myDataBinding?.data);
      ...
      if (
        ...
        ctx.fillText(this._title, 20, 38);

        ctx.fillStyle = "#444";
        ctx.font = "20px Arial";
        ctx.fillText("No Data Available", 40, 120);
      ...
      ctx.fillText(this._title, 20, 45);
      ...
      const drawCard = (x, y, value, label, valueColor, labelColor) => {
        ...
        ctx.fillText(value, x + cardWidth / 2, y + 32);

        ctx.fillStyle = labelColor;
        ctx.font = "bold 14px Arial";

        ctx.fillText(label, x + cardWidth / 2, y + 60);
      ...
      data.forEach((item, index) => {
        ...
        ctx.fillText(this.formatValue(item.value), 1340, y);
        ...
        ctx.beginPath();
        ctx.roundRect(40, y, (1300 * percent) / 100, 20, 10);
